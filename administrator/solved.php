        ...
        <div class="content">
                    ...
                    while ($row = $result_pengaduan->fetch_assoc()) {
                        ...
                        <div class='report-row'>
                            ...
                            <div class='delete-item'>
                                <a href='proc/delete_pengaduan.php?id=".$row['id']."&page=solved' onclick='return confirm(`Apakah Anda yakin ingin menghapus?  `);'><img src='img/delete.png'></a>
                            </div>
                        </div>
                        ";
                    }
            ...
            <div id="reportModal" class="modal">
                ...
                <div class="modal-content tanggapan">
                    <h3>Tanggapan</h3>
                    <form action="proc/tanggapan.php?page=solved" method="POST">
