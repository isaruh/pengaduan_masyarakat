...
$sql = "SELECT * FROM pengaduan WHERE status = 'accepted' ORDER BY created_at DESC";
...
<head>
    ...
    <style>
        * {
        ...
        .modal-content.tanggapan form {
            display: flex;
            justify-content: space-between;
        }

        .modal-content.tanggapan input[type="text"] {
            width: 75%;
            padding: 10px;
            border: 1px solid #ddd;
            border-radius: 5px;
        ...
        .modal-content.tanggapan input[type="submit"] {
            width: 20%;
            padding: 10px;
            color: white;
                    ...
                    while ($row = $result_pengaduan->fetch_assoc()) {
                        ...
                        <div class='report-row'>
                            ...
                            <div class='delete-item'>
                                <a href='proc/delete_pengaduan.php?id=".$row['id']."&page=unprocessed' onclick='return confirm(`Apakah Anda yakin ingin menghapus?  `);'><img src='img/delete.png'></a>
                            </div>
                        </div>
                        ";
                    }
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="footer-right">
                            ...
                            <a href="" class="processed" id="processedLink">processed</a>
                        </div>
                    </div>
                </div>
                <div class="modal-content tanggapan">
                    <h3>Tanggapan</h3>
                    <form action="proc/tanggapan.php?page=unprocessed" method="POST">
                        <input type="hidden" name="id_penanggap" value="<?= $_SESSION['id_admin']; ?>">
                        <input type="hidden" name="username_pengadu" value="">
                        <input type="hidden" name="id_pengaduan" value="">
                        <input type="text" name="isi" placeholder="Tulis tanggapan" autocomplete="off" minlength="3" required>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function showModal(data) {
                ...
                document.getElementById("rejectLink").href = "proc/change_status.php?page=unprocessed&status=rejected&id=" + data.id;
                document.getElementById("processedLink").href = "proc/change_status.php?page=unprocessed&status=pending&id=" + data.id;
                ...
                // Set the values for hidden inputs (username_pengadu and id_pengaduan)
                const form = document.querySelector("form");
                form.querySelector("input[name='username_pengadu']").value = data.user;
                form.querySelector("input[name='id_pengaduan']").value = data.id;
